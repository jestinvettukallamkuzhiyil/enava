...
def attendance_report(request):
 ...
 # Get start and end dates from query parameters
    ...
    if start_date and end_date:
        ...
        attendance_data = AttendanceReport.objects.all()
    ...
    # Get all the students and their attendance data
        students = Student.objects.filter(session_id=session_id)
        attendance_data = []
        for student in students:
            attendance_count = AttendanceReport.objects.filter(student=student)
    ...
    # Set up the PDF document
        ...
        # Calculate attendance counts
            for record in attendance_count:
                total_days += 1
    ...
    pdf_canvas.drawString(350, y, "Total days")
    pdf_canvas.drawString(500, y, "present days")
    pdf_canvas.drawString(650, y, "Absent days")
    y -= 20
    for student in students:
        ...
        pdf_canvas.drawString(350, y, str(total_days))
        pdf_canvas.drawString(500, y, str(present_days))
        pdf_canvas.drawString(650, y, str(total_days - present_days))
        y -= 20
