...
def admin_home(request):
    ...
    for department in department_all:
        ...
        staff_count_list_in_department.append(staff_count)



    leave_all=LeaveReportStaff.objects.all()
    leave_name_list=[]
    leave_messsage_list=[]
    leave_date_list=[]
    leave_status_list=[]
    ...
    for leave in leave_all:
        ...
        leave_name_list.append(leave.staff)
        leave_messsage_list.append(leave.message)
        leave_date_list.append(leave.date)
        leave_status_list.append(leave.status)
    ...
    context = {
        ...
        "leave_name_list":leave_name_list,
        "leave_messsage_list":leave_messsage_list,
        "leave_date_list":leave_date_list,
...
def course_student_list(request, course_ids):
    ...
    # Loop through the course IDs and add the student list to the PDF document
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            try:
                ...
                user.aadhar_num = aadhar_num
                user.religion = religion
                user.department = department
                user.register_num = register_num
                user.admission_num = admission_num
